...
function bootstrap_shortcodes_styles_all() {
    wp_register_style( 'bootstrap-shortcodes-help-all', get_stylesheet_directory_uri().'/lib/bsshortcode/includes/help/css/bootstrap-shortcodes-help-all.css'  );
...
function bootstrap_shortcodes_help_styles() {
  wp_register_style( 'bs-font', get_stylesheet_directory_uri().'/lib/bsshortcode/includes/help/bs-font.css' );
  wp_register_style( 'bootstrap-shortcodes-help', get_stylesheet_directory_uri().'/lib/bsshortcode/includes/help/css/bootstrap-shortcodes-help.css' );
  wp_register_style( 'bootstrap-modal', get_stylesheet_directory_uri().'/lib/bsshortcode/includes/help/css/bootstrap-modal.css'  );
  wp_register_script( 'bootstrap', get_stylesheet_directory_uri().'/lib/bsshortcode/includes/help/js/bootstrap.min.js'  );
