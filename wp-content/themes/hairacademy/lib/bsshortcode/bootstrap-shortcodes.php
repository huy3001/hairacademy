...
class BoostrapShortcodes {
  ...
  function bootstrap_shortcodes_scripts()  { 
    ...
    wp_enqueue_script( 'bootstrap-shortcodes-tooltip', get_stylesheet_directory_uri() . '/lib/bsshortcode/includes/js/bootstrap-shortcodes-tooltip.js', array( 'jquery' ), false, true );
    
    // Bootstrap popover js
    wp_enqueue_script( 'bootstrap-shortcodes-popover', get_stylesheet_directory_uri() . '/lib/bsshortcode/includes/js/bootstrap-shortcodes-popover.js', array( 'jquery' ), false, true );
