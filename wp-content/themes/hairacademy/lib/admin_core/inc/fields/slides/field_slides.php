        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'btntitle' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'btntitle' ] ) : __ ( 'Button Title', 'redux-framework' );
                    echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-btntitle' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][btntitle]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'btntitle' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
